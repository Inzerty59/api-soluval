...
document.addEventListener('DOMContentLoaded', (event) => {
    document.getElementById('eye-icon1').addEventListener('click', () => togglePasswordVisibility('password', 'eye-icon1'));
    document.getElementById('eye-icon2').addEventListener('click', () => togglePasswordVisibility('confirm-password', 'eye-icon2'));
});