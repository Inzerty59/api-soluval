 ...
 */
final class Version20250303152823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, billing_adress_id INT DEFAULT NULL, delivery_adress_id INT DEFAULT NULL, to_send TINYINT(1) NOT NULL, is_free_shipping TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', order_number VARCHAR(255) NOT NULL, INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F529939830959BF2 (billing_adress_id), INDEX IDX_F5299398C0E3B53E (delivery_adress_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE part (id INT AUTO_INCREMENT NOT NULL, order_id INT DEFAULT NULL, external_id INT NOT NULL, manufacturer_reference VARCHAR(40) DEFAULT NULL, adaptable_reference VARCHAR(40) DEFAULT NULL, category_name VARCHAR(80) DEFAULT NULL, description VARCHAR(1000) DEFAULT NULL, part_condition INT DEFAULT NULL, warranty INT DEFAULT NULL, brand_name VARCHAR(80) DEFAULT NULL, range_name VARCHAR(80) DEFAULT NULL, model_name VARCHAR(80) DEFAULT NULL, finish_name VARCHAR(255) DEFAULT NULL, commercial_designation VARCHAR(255) DEFAULT NULL, vehicle_year INT DEFAULT NULL, mileage INT DEFAULT NULL, color_name LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', displacement INT DEFAULT NULL, power VARCHAR(80) DEFAULT NULL, energy_name VARCHAR(80) DEFAULT NULL, gearbox_type LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', engine_code VARCHAR(80) DEFAULT NULL, gearbox_code VARCHAR(80) DEFAULT NULL, door_number INT DEFAULT NULL, vignette VARCHAR(512) DEFAULT NULL, photos LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', price LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', casse_id INT NOT NULL, shipping_id INT DEFAULT NULL, weight VARCHAR(255) NOT NULL, origin INT DEFAULT NULL, available TINYINT(1) NOT NULL, INDEX IDX_490F70C68D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
