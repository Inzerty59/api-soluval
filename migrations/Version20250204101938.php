 ...
 */
final class Version20250204101938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE billing_adress (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, shipping_id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, phone INT NOT NULL, street VARCHAR(255) NOT NULL, street_additionnal VARCHAR(255) DEFAULT NULL, post_code VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, country_id INT NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_1936E4EEA76ED395 (user_id), INDEX IDX_1936E4EE4887F3F8 (shipping_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE delivery_adress (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, shipping_id INT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, phone INT NOT NULL, street VARCHAR(255) NOT NULL, street_additionnal VARCHAR(255) DEFAULT NULL, post_code VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, country_id INT NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_42FD3E30A76ED395 (user_id), INDEX IDX_42FD3E304887F3F8 (shipping_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, billing_adress_id INT DEFAULT NULL, delivery_adress_id INT DEFAULT NULL, mango_pay_id INT DEFAULT NULL, to_send TINYINT(1) NOT NULL, is_free_shipping TINYINT(1) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', status LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F529939830959BF2 (billing_adress_id), INDEX IDX_F5299398C0E3B53E (delivery_adress_id), INDEX IDX_F5299398574FB19E (mango_pay_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
