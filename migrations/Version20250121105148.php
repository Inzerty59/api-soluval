 ...
 */
final class Version20250121105148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE part (id INT AUTO_INCREMENT NOT NULL, external_id INT NOT NULL, manufacturer_reference VARCHAR(40) DEFAULT NULL, opisto_reference VARCHAR(40) DEFAULT NULL, category_name VARCHAR(80) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, part_condition INT DEFAULT NULL, warranty INT DEFAULT NULL, brand_name VARCHAR(80) DEFAULT NULL, range_name VARCHAR(80) DEFAULT NULL, model_name VARCHAR(80) DEFAULT NULL, finish_name VARCHAR(255) DEFAULT NULL, commercial_name VARCHAR(255) DEFAULT NULL, vehicle_year INT DEFAULT NULL, mileage INT DEFAULT NULL, color_name VARCHAR(80) DEFAULT NULL, displacement INT DEFAULT NULL, power VARCHAR(80) DEFAULT NULL, energy_name VARCHAR(80) DEFAULT NULL, gearbox_type VARCHAR(80) DEFAULT NULL, engine_code VARCHAR(80) DEFAULT NULL, gearbox_code VARCHAR(80) DEFAULT NULL, door_number INT DEFAULT NULL, vignette VARCHAR(255) DEFAULT NULL, photos LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', price LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, external_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, stock INT NOT NULL, created_at DATETIME NOT NULL, update_at DATETIME NOT NULL, images LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', stripe_payment_id INT NOT NULL, payment_status VARCHAR(100) NOT NULL, total_amount VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, surname VARCHAR(100) NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, client_id VARCHAR(255) NOT NULL, secret_id VARCHAR(255) NOT NULL, api_token VARCHAR(255) DEFAULT NULL, token_expires_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, company_name VARCHAR(255) DEFAULT NULL, siret_number VARCHAR(14) DEFAULT NULL, vat_number VARCHAR(20) DEFAULT NULL, account_type VARCHAR(255) NOT NULL, roles JSON NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D64919EB6921 (client_id), UNIQUE INDEX UNIQ_8D93D64967176C07 (secret_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
